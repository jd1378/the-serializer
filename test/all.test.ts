  ...
  it('can serialize complex objects', () => {
    const obj = {
      [Symbol.for('foo')]: {
        ...
        k: [new Date('2024-09-01T04:12:39.730Z'), new RegExp('foo\\}\\{bar\\}', 'g')],
      },
    };
    expect(serialize(obj)).toBe(
      '[{"{#$_s:foo}":"1"},{"a":"2","b":"3","c":"4","d":"5","k":"6"},"{#$_M:[[\\"1\\"],[\\"2\\",\\"3\\"],\\"foo\\",\\"bar\\"]}","{#$_S:[[\\"1\\",\\"2\\"],\\"foo\\",\\"bar\\"]}","{#$_R:foo\\\\}\\\\{bar\\\\}}g",{"e":"7","f":"8","g":"2","h":"3","i":"9"},["8","4"],"{#$_L:http%3A%2F%2Fexample.foo%2F}","{#$_D:2024-09-01T04:12:39.730Z}",{"j":"10"},"{#$_u}"]',
    );
  });
});
